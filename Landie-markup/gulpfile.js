...
function scripts() {
	return src(['app/assets/js/*.js', '!app/assets/js/*.min.js'])
		.pipe(webpack({
			mode: 'production',
...
function buildcopy() {
	return src([
		'{app/assets/js,app/assets/css}/*.min.*',
		'app/assets/images/**/*.*',
...
function startwatch() {
	...
	watch('app/assets/images/src/**/*.{jpg,jpeg,png,webp,svg,gif}', { usePolling: true }, images)
